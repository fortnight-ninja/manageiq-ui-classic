module VmHelper::TextualSummary
  ...
  def textual_retirement_date
    # Click2Cloud: Added orange cloudmanager template condition
    return nil if @record.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Template) || @record.kind_of?(ManageIQ::Providers::Orange::CloudManager::Template) || @record.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::Template)
